...
import { WebhookTypeValue } from '../webhooks/types';
...
export declare function validateHmacFromRequestFactory(config: ConfigInterface): ({ type, rawBody, webhookType, ...adapterArgs }: ValidateParams) => Promise<ValidationInvalid | ValidationValid>;
