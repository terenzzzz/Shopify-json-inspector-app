...
export declare const WEBHOOK_HEADER_NAMES: {
    readonly webhooks: {
        readonly hmac: ShopifyHeader.Hmac;
        readonly topic: ShopifyHeader.Topic;
        readonly domain: ShopifyHeader.Domain;
        readonly apiVersion: ShopifyHeader.ApiVersion;
        readonly webhookId: ShopifyHeader.WebhookId;
        readonly subTopic: ShopifyHeader.SubTopic;
        readonly name: ShopifyHeader.Name;
        readonly triggeredAt: ShopifyHeader.TriggeredAt;
        readonly eventId: ShopifyHeader.EventId;
    };
    readonly events: {
        readonly hmac: "shopify-hmac-sha256";
        readonly topic: "shopify-topic";
        readonly domain: "shopify-shop-domain";
        readonly apiVersion: "shopify-api-version";
        readonly webhookId: "shopify-webhook-id";
        readonly eventId: "shopify-event-id";
        readonly handle: "shopify-handle";
        readonly action: "shopify-action";
        readonly resourceId: "shopify-resource-id";
        readonly triggeredAt: "shopify-triggered-at";
    };
};
...
type WebhookEndpoint = WebhookHttpEndpoint | WebhookEventBridgeEndpoint | WebhookPubSubEndpoint;
...
export type WebhookValidationValid = WebhookFields & {
    valid: true;
};
