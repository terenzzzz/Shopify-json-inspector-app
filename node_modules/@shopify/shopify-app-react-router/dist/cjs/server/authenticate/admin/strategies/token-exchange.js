...
var ensureOfflineTokenIsNotExpired = require('../../../helpers/ensure-offline-token-is-not-expired.js');
...
const createTokenExchangeStrategy = (params) => {
    ...
    async function authenticate(request, sessionContext) {
        ...
        if (!session ||
            !session.isActive(undefined, ensureOfflineTokenIsNotExpired.WITHIN_MILLISECONDS_OF_EXPIRY)) {
